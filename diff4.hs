...
data DiffStruct =
  MkDiffStruct
    ...
    , documentsTokenFrequencyDifferent :: Integer
    , documentsTokenFrequencySame      :: Integer
    }
  deriving (Show)
...
tokenwiseResult :: FileData -> FileData -> (Int,Int, Int, Integer, Integer)
...
compareMap :: [(T.Text, DocumentData)] -> FileData -> (Int, Int, Int, Integer, Integer)
...
compareMap ((k, v):ms) m2 = if res == emptyDocumentData then  compareMap ms m2
    ...
    add :: (Int,Int, Int, Integer, Integer) -> (Int, Int, Int, Integer, Integer) -> (Int, Int, Int, Integer, Integer)
...
-}
compareDocumentData :: DocumentData -> DocumentData -> (Int, Int, Int, Integer, Integer)
...
compareFreqMap :: Map Int Int -> Map Int Int -> (Int, Int, Integer, Integer)
...
compareIndividualKey :: [(Int, Int)] -> Map Int Int -> Integer
